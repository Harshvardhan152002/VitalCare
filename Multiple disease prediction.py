...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep 5 19:57:45 2024

@author: Harsh Vardhan Gupta
"""
import os
import pickle
...
st.set_page_config(page_title="Vital Care", layout="wide", page_icon=r"C:\Users\harsh\Desktop\Multiple Disease system\heart-attack.png")

working_dir = os.path.dirname(os.path.abspath(__file__))

diabetes_model = pickle.load(open('C:/Users/harsh/Desktop/Multiple Disease system/models/diabetes_model.sav', 'rb'))
heart_disease_model = pickle.load(open('C:/Users/harsh/Desktop/Multiple Disease system/models/heart_disease_model.sav', 'rb'))
parkinsons_model = pickle.load(open('C:/Users/harsh/Desktop/Multiple Disease system/models/parkinsons_model.sav', 'rb'))
...
with st.sidebar:
    selected = option_menu('Multiple Disease Prediction System', 
                           ...
                           default_index=0)
    st.image(r'C:\Users\harsh\Desktop\Multiple Disease system\Vital Care.png')  # Add this line to test the image
